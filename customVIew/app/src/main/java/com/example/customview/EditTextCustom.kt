...
class EditTextCustom(context: Context, attrs: AttributeSet?) :
    ...
    fun init() {
        darkButton = ResourcesCompat.getDrawable(resources, R.drawable.baseline_close_24, null )
        lightButton = ResourcesCompat.getDrawable(resources, R.drawable.baseline_close_red_24, null )
